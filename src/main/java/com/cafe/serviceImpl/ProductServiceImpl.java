...
import com.cafe.dao_repository.ProductDao;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ResponseEntity<List<ProductWrapper>> getAllProducts() {
        try {
            ...
            //tu sme zavolali metódu, ktorá pôjde do interfacu productDao, a ten sa pozrie do POJO-Produkt a tam bude hľadať
            //túto metódu, lebo tam bude napísaný query
        } catch (Exception ex) {
            ex.printStackTrace();
        }
